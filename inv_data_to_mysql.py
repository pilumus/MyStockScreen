...
try:
    # TODO: Переписать запрос, чтобы брал ссылки только тех компаний, по которым нет записей в fs_reg. Используем Not Exists
    ...
    for link in query_result:
        ...
        #TODO: Обход ошибки, когда нет финансовой отчетности, как в ссылках по АДР
        # https://www.investing.com/equities/jpmorgan-chase---co-ph-adr-financial-summary
